...
For further details and technical definitions, please refer to the [OID4VCI specification](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0-15.html).
